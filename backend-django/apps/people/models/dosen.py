...
class Dosen(models.Model):
    ...
    jabatan_fungsional = models.ForeignKey(JabatanFungsional, on_delete=models.SET_NULL, null=True, blank=True)
    pangkat_golongan = models.ForeignKey(PangkatGolongan, on_delete=models.SET_NULL, null=True, blank=True)
    program_studi = models.ForeignKey(ProgramStudi, on_delete=models.SET_NULL, null=True, blank=True)
    bidang_kepakaran = models.ForeignKey(BidangKepakaran, on_delete=models.SET_NULL, null=True, blank=True)
